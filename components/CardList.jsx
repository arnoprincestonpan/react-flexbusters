...
const CardList = ( {horrorMovies} ) => {
  const calculatePostersPerRow = () => {
    ...
    const [moviesToDisplay, setMoviesToDisplay] = useState(horrorMovies.slice(0, calculatePostersPerRow()));
    useEffect(() => {
        const handleResize = () => {
          const newPostersPerRow = calculatePostersPerRow();
          setPostersPerRow(newPostersPerRow);
          setMoviesToDisplay(horrorMovies.slice(0, newPostersPerRow));
        };
      ...
      useEffect(() => {
        setMoviesToDisplay(horrorMovies.slice(0, postersPerRow));
      }, [postersPerRow, horrorMovies]);
  return(
